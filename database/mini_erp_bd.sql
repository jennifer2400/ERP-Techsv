...
-- Tiempo de generación: 25-11-2025 a las 19:36:09
...
ALTER TABLE `detalle_factura`
  ...
  ADD CONSTRAINT `detalle_factura_ibfk_2` FOREIGN KEY (`id_inventario`) REFERENCES `inventario` (`id_inventario`) ON UPDATE CASCADE;
